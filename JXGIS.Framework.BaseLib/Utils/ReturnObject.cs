...
namespace JXGIS.Framework.BaseLib
{
    ...
    public class ReturnObject
    {
        ...
        public ReturnObject(System.Exception ex) : this(ex.Message)
        {
        }

        public ReturnObject(System.Exception ex, bool showDefaultErrorMessage) : this(ex.Message, showDefaultErrorMessage)
        {
        }
